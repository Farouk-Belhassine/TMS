...
QRegExp rx("[A-Za-z_]+");//[A-Za-z0-9_]
   ...
   connect(m_manager, &QNetworkAccessManager::finished, this, &jasser::uploadFinished);
...
void jasser::on_pb_supprimer_clicked()
{
...
void jasser::on_modifier_clicked()
{
...
void jasser::on_imprimer_clicked()
{
    QString str;
...
void jasser::sendMailstation()
{Smtp* smtp = new Smtp("cpp.projet.cpp@gmail.com", "c++testc++", "smtp.gmail.com", 465);
connect(smtp, SIGNAL(status(QString)), this, SLOT(mailSent(QString)));


    smtp->sendMail("cpp.projet.cpp@gmail.com", ui->rcpts->text() , "tableau de gestion des reseaux des bus",0);
}
void jasser::mailSent(QString status)
{
...
void jasser::on_afficher_clicked()
{
    ui->tabreseau->setModel(tmpreseau.afficher());
}

void jasser::on_send0_clicked()
{
    ui->stackedWidget->setCurrentIndex(0);
}

void jasser::on_pushButton_clicked()
{
    ui->stackedWidget->setCurrentIndex(1);
}
...
void jasser::on_ajouter2_clicked()
{
...
void jasser::on_modifiers_clicked()
{
...
void jasser::on_pb_supprimers_clicked()
{
...
void jasser::on_affichers_clicked()
{
    ui->tabstation->setModel(tmpstation.afficher());
}

void jasser::on_triers_clicked()
{
    QSqlQueryModel * model=tmpstation.trier();
    ui->tabstation->setModel(model);
}

void jasser::on_stats_clicked()
{
    ui->tabstation->setModel(tmpstation.stat());

}

void jasser::on_send0s_clicked()
{
...
void jasser::on_pushButtons_clicked()
{
...
void jasser::on_imprimers_clicked()
{
...
void jasser::on_recherche_clicked()
{
...
void jasser::on_recherches_clicked()
{
...
void jasser::on_uploadButton_clicked()
{
    ...
    m_file = new QFile(path[0]);
      ...
      if (m_file->open(QIODevice::ReadOnly))
       ...
       if (m_file->open(QIODevice::ReadOnly))
       {
           ...
           connect(reply, &QNetworkReply::uploadProgress, this, &jasser::uploadProgress);
       }
}


void jasser::uploadFinished(QNetworkReply *reply)
{
...
void jasser::uploadProgress(qint64 bytesSent, qint64 bytesTotal)
{
