...
mwplace::mwplace(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::mwplace)
{
    ui->setupUi(this);
...
void mwplace::on_pb_ajouter_clicked()
{
...
void mwplace::on_pb_modifier_clicked()
{
    int id = ui->lineEdit_id->text().toInt();
    int cin = ui->lineEdit_cin->text().toInt();
    QString nom= ui->lineEdit_nom->text();
...
void mwplace::on_pb_supprimer_clicked()
{
    int id = ui->lineEdit_id->text().toInt();
...
void mwplace::on_pb_show_clicked()
{
...
void mwplace::on_pushButton_4_clicked()
{
    m = new Mailer(this);
    m->show();
}

void mwplace::on_pushButton_3_clicked()
{
    ui->tabplace->setModel(tmp.afficherf());

}

void mwplace::on_pushButton_2_clicked()
{
...
void mwplace::on_pb_retour_clicked()
{
...
void mwplace::on_pushButton_clicked()
{
    mwplace::setStyleSheet("background-color: white");
...
void mwplace::on_pushButton_5_clicked()
{
    mwplace::setStyleSheet("background-color: black");
